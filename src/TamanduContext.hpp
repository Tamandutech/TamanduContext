...
template <class T>
Context<T>::Context(std::string name, T value)
{
...
template <class T>
std::string Context<T>::getString(std::string ctrl)
{
    // retorna o valor do dado
...
template <class T>
void Context<T>::set(std::string data)
{
